...
<script>
	function addGoodSort(){
		...
		$.post(basePath+'/GoodSortAction',{type:"add"
			,name:name},function(result){
				if(result=='success'){
					window.event.returnValue=false;
					window.location.href=basePath+"/content/good/good_sort.jsp?message=添加成功"
				}else{
					alert('删除失败')
				}
			})
...
<div class="content">
	...
	<div class="right_main">
		...
		<tr>
			<td>&nbsp;</td>
			<td>
				<input type="button" name="pesubmit" onclick="addGoodSort()" value="提 交" class="tjbtn">
			</td>
		</tr>
		</tbody></table>
		</form>
