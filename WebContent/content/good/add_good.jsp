...
<script type="text/javascript">
	$(function(){
		...
		$('#submit').click(function(){
			...
			var num = $('#num').val()
			$.post(basePath+'/GoodAction',{type:'add'
				,name:name
				,sortId:sortId
				,getPrice:getPrice
				,sellPrice:sellPrice
				...
				,num:num},function(result){
					if(result=='success'){
						location.href = basePath+'/content/good/good.jsp?message=添加成功'
			...
			<div class="right" style="height: 349px;">
				...
				<form method="post" enctype="multipart/form-data">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="wenzhang mat20 mab20">
							<tbody>
								<tr>
									...
									<td colspan="3"><input type="text" id='name' value="" class="inputall input700"></td>
								</tr>
								<tr>
									<td align="right" width="150">商品分类：</td>
									<td>
										<select name="info[category_id]" id="sortId" class="inputselect" style="width: 250px">
								...
								<tr id="base_html">
									...
									<td>
										<table width="100%" class="list" style="width:702px;border:1px #eee solid">
											...
											<tr>
												<td><input type="text" id="getPrice" value="0" class="inputtext input100" /> 元</td>
												<td><input type="text" id="sellPrice" value="0" class="inputtext input100" /> 元</td>
												<td><input type="text" id="num"  value="" class="inputtext input100" /> 件</td>
											</tr>
										</table>
									</td>
								</tr>
								...
								<tr>
									...
									<td><input type="text" name="info[product_wlmoney]" value="0" class="inputall input100"> <span class="c888">元</span></td>
								</tr>
								<tr>
									<td align="right">赠送积分：</td>
									<td><input type="text" name="info[product_point]" value="0" class="inputall input100"> <span class="c888">点</span></td>
								</tr>
							</tbody>
						</table>
					</div>
								...
								<tr>
									...
									<td>
										<div class="upload_html fl" lock="0">
											<input type="hidden" name="product_album[]" value="" class="upload_value">
											<a href="javascript:;" class="upload_btn webuploader-container">
												<div class="webuploader-pick">
													<img src="${basePath}/images/up_bg.jpg" id="viewImg" onclick="upload()" class="upload_logo" style="width: 125px; height: 125px;">
													<input type="file" style="display:none" id="fileToUpload" name="fileToUpload" multiple="multiple" onchange="ajaxFileUpload()" accept="image/*">
												
												</div>
												<div id="" style="position: absolute; top: 0px; left: 0px; width: 125px; height: 125px; overflow: hidden; bottom: auto; right: auto;">
					...
					<div class="center mat20 mab20">
						<input type="button" value="提 交"  id="submit" class="tjbtn">
						<input type="button" value="返回"  id="back" onclick="window.location='${basePath}/good/good.jsp'" class="tjbtn">
					</div>
				</form>
			</div>
