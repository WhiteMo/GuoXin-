...
<div class="content">
	...
	<div class="now" style="width: 1125px;">
		<a href="admin.php?mod=adminlevel" class="sel">管理权限（2）</a>
	...
	<div class="right_main" style="padding-bottom: 0px;">
		...
		<tbody><tr>
			...
			<td></td>
			<td>
								<a href="admin.php?mod=adminlevel&amp;act=edit&amp;id=2" class="admin_edit mar3">修改</a>
				<a href="admin.php?mod=adminlevel&amp;act=del&amp;id=2&amp;token=891521e3fb0d6b90839d575e2f7afa7d" class="admin_del" onclick="return pe_cfone(this, '删除')">删除</a>
							</td>
		</tr>
				</tbody></table>
		</form>
