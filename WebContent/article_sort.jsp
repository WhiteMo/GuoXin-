...
<title>文章分类 - 欢迎使用PHPSHE商城系统</title>
...
<div class="content">
	<div class="left" style="height: 143px;">
			...
			<ul>
								<li class="sel"><a href="admin.php?mod=class"><span>├</span>文章分类</a></li>
	...
	<div class="now" style="width: 1125px;">
		<a href="admin.php?mod=class" class="sel">资讯中心</a>
		<a href="admin.php?mod=class&amp;type=help">帮助中心</a>
		<a href="admin.php?mod=class&amp;act=add" id="fabu">添加分类</a>
				<div class="clear"></div>
	</div>
	<div class="right_main" style="padding-bottom: 0px;">
		...
		<tbody><tr>
			...
			<th class="bgtt">分类名称
			</th><th class="bgtt" width="110">操作</th>
		</tr>
				<tr>
			<td><input type="text" name="class_order[1]" value="0" class="inputtext input40 center"></td>
			<td class="aleft"><a href="http://localhost/shop4/index.php/article/list-1" target="_blank">网站公告</a></td>
			<td>
				<a href="admin.php?mod=class&amp;act=edit&amp;id=1&amp;fromto=http%3A%2F%2Flocalhost%2Fshop4%2Fadmin.php%3Fmod%3Dclass" class="admin_edit mar3">修改</a>
				<a href="admin.php?mod=class&amp;act=del&amp;id=1&amp;token=67ed2865164bef115fded4aeff673f71" class="admin_del" onclick="return pe_cfone(this, '删除')">删除</a>
			</td>
		</tr>
				<tr>
			<td><input type="text" name="class_order[2]" value="1" class="inputtext input40 center"></td>
			<td class="aleft"><a href="http://localhost/shop4/index.php/article/list-2" target="_blank">公司动态</a></td>
			<td>
				<a href="admin.php?mod=class&amp;act=edit&amp;id=2&amp;fromto=http%3A%2F%2Flocalhost%2Fshop4%2Fadmin.php%3Fmod%3Dclass" class="admin_edit mar3">修改</a>
				<a href="admin.php?mod=class&amp;act=del&amp;id=2&amp;token=67ed2865164bef115fded4aeff673f71" class="admin_del" onclick="return pe_cfone(this, '删除')">删除</a>
			</td>
		</tr>
				<tr>
			<td><input type="text" name="class_order[3]" value="2" class="inputtext input40 center"></td>
			<td class="aleft"><a href="http://localhost/shop4/index.php/article/list-3" target="_blank">相关知识</a></td>
			<td>
				<a href="admin.php?mod=class&amp;act=edit&amp;id=3&amp;fromto=http%3A%2F%2Flocalhost%2Fshop4%2Fadmin.php%3Fmod%3Dclass" class="admin_edit mar3">修改</a>
				<a href="admin.php?mod=class&amp;act=del&amp;id=3&amp;token=67ed2865164bef115fded4aeff673f71" class="admin_del" onclick="return pe_cfone(this, '删除')">删除</a>
			</td>
		</tr>
				</tbody></table>
		</form>
	...
	<div class="right_bottom">
		<span class="fl">
			<button href="admin.php?mod=class&amp;act=order&amp;token=67ed2865164bef115fded4aeff673f71" onclick="pe_doall(this,'form')">批量排序</button>
		</span>
