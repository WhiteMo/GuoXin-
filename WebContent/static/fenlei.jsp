...
%>
	<div class="fenlei">
		...
		<ul>
			<li class="">
				<a href="${basePath}/content/good/good.jsp"><span>├</span>商品列表</a>
			</li>
			<li class="">
				<a href="${basePath}/content/good/good_sort.jsp"><span>├</span>商品分类</a>
			</li>
	...
	<div class="fenlei">
		...
		<ul>
			<li class="">
				<a href="${basePath}/content/order/order.jsp"><span>├</span>订单列表</a>
			</li>
