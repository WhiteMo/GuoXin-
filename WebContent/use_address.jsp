...
<title>收货地址 - PHPSHE B2C商城系统演示站 - Powered by phpshe</title>
<meta name="keywords" content="phpshe,php,shop,php商城系统,b2c商城系统,php商城源码,b2c商城源码,开源免费网上商城系统">
<meta name="description" content="phpshe,php,shop,php商城系统,b2c商城系统,php商城源码,b2c商城源码,开源免费网上商城系统">
...
<div class="content">
	...
	<div class="now" style="width: 1125px;">
		<a href="admin.php?mod=user">会员列表（1）</a>
		<a href="admin.php?mod=userbank">收款账户（0）</a>
		<a href="admin.php?mod=useraddr" class="sel">收货地址（0）</a>
		<div class="clear"></div>
	</div>
	<div class="right_main" style="padding-bottom: 0px;">
		...
		<tbody><tr>
			...
			<th class="bgtt" width="110">操作</th>
				...
				<tr>
			<td style="background-color: rgb(255, 255, 255);"><input type="checkbox" name="address_id[]" value="1"></td>
			<td class="num" style="background-color: rgb(255, 255, 255);">1</td>
			<td style="background-color: rgb(255, 255, 255);">18810522533</td>
			<td style="background-color: rgb(255, 255, 255);">吴鑫</td>
			<td class="num" style="background-color: rgb(255, 255, 255);">18810522533</td>
			<td class="aleft" style="background-color: rgb(255, 255, 255);">广东 中山 中山市 多撒多</td>
			<td class="num" style="background-color: rgb(255, 255, 255);"><span>2018-03-13 11:42</span></td>
			<td style="background-color: rgb(255, 255, 255);">
				<a href="admin.php?mod=useraddr&amp;act=edit&amp;id=1" onclick="return pe_dialog(this, '修改收货地址', 650, 400);" class="admin_edit mar3">修改</a>
				<a href="admin.php?mod=useraddr&amp;act=del&amp;id=1&amp;token=67ed2865164bef115fded4aeff673f71" class="admin_del" onclick="return pe_cfone(this, '删除')">删除</a>
			</td>
		</tr>
				</tbody></table>
		</form>
	...
	<div class="right_bottom">
		<span class="fl mal10">
			...
			<button href="admin.php?mod=useraddr&amp;act=del&amp;token=67ed2865164bef115fded4aeff673f71" onclick="return pe_cfall(this, 'address_id', 'form', '批量删除')">批量删除</button>
		</span>
