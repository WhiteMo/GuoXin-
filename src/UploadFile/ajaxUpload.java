...
public class ajaxUpload extends HttpServlet {
	...
	// 保存文件的目录
	private static String PATH_FOLDER = "/images";
	// 存放临时文件的目录
	private static String TEMP_FOLDER = "/images/temp";
	...
	public void init(ServletConfig config) throws ServletException {
		...
		// 初始化路径
		// 保存文件的目录
		PATH_FOLDER = servletCtx.getRealPath("/images");
		// 存放临时文件的目录,存放xxx.tmp文件的目录
		TEMP_FOLDER = servletCtx.getRealPath("/images/temp");
	}
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			String picUrl = request.getContextPath()+"/images/"+saveName;
